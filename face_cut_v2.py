...
def main():
    ...
    parser.add_argument('--haar_file', '-c', type=str, default=os.path.dirname(os.path.abspath(__file__))+'/haarcascade_frontalface_alt.xml'.replace('/', os.sep),
                        help='haar-Cascadeのパス指定(デフォルト値=./haarcascade_frontalface_alt.xml)')
